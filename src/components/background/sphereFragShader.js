...
void main() {
  ...
  float whiteFactor = smoothstep(0.95, 1.0, length(animColor));
  // Plus de jaune (0.8) et moins de blanc (0.2) dans le mix final
  vec3 finalColors = mix(dynamicYellow, vec3(1.0), whiteFactor * 0.2) * 0.8 + dynamicYellow * 0.2;
